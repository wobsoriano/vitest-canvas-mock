...
describe('canvasGradient', () => {
  ...
  it('canvasGradient different instance', () => {
  ...
  [Infinity, Number.NaN, -Infinity].forEach((value) => {
    it(`CanvasGradient should throw if offset is ${value}`, () => {
      const fn = () => {
  ...
  it('should accept all valid CSS colors as a color stop', () => {
  ...
  it('canvasGradient should throw if color cannot be parsed', () => {
    const grd = ctx.createLinearGradient(1, 2, 3, 4)
    expect(() => {
