...
describe('mockWindow', () => {
  it('mocks the passed object', () => {
    ...
    expect(vi.isMockFunction(win.HTMLCanvasElement.prototype.getContext)).toBe(true);
    expect(vi.isMockFunction(win.HTMLCanvasElement.prototype.toBlob)).toBe(true);
    expect(vi.isMockFunction(win.HTMLCanvasElement.prototype.toDataURL)).toBe(true);
  });
