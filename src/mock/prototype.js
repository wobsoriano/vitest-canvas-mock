...
export default function mockPrototype(win) {
  ...
  if (!vi.isMockFunction(getContext)) {
    getContext2D.internal = getContext;
  } else {
    getContext2D.internal = getContext.internal;
  }
  ...
  if (!vi.isMockFunction(toBlob)) {
    toBlobOverride.internal = toBlob;
  } else {
    toBlobOverride.internal = toBlob.internal;
  }
  ...
  if (!vi.isMockFunction(toDataURL)) {
    toDataURLOverride.internal = toDataURL;
  } else {
    toDataURLOverride.internal = toDataURL.internal;
  }
