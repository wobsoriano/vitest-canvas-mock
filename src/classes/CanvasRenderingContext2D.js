...
export default class CanvasRenderingContext2D {
  ...
  addHitRegion(options = {}) {
    ...
    if (fillRule && fillRule !== 'evenodd' && fillRule !== 'nonzero') {
      throw new TypeError(
        `Failed to execute 'addHitRegion' on '${this.constructor.name}': The provided value '${
          fillRule
  ...
  arc(x, y, radius, startAngle, endAngle, anticlockwise = false) {
    if (arguments.length < 5) {
      throw new TypeError(
        `Failed to execute 'arc' on '${this.constructor.name}': 5 arguments required, but only ${
          arguments.length
        } present.`,
      );
    }
    ...
    if (Number(radius) < 0) {
      throw new DOMException(
        `Failed to execute 'arc' on '${this.constructor.name}': The radius provided (${
          radius
        }) is negative.`,
        'IndexSizeError',
      );
  ...
  arcTo(cpx1, cpy1, cpx2, cpy2, radius) {
    if (arguments.length < 5) {
      throw new TypeError(
        `Failed to execute 'arcTo' on '${this.constructor.name}': 5 arguments required, but only ${
          arguments.length
        } present.`,
      );
    }
    ...
    if (radiusResult < 0) {
      throw new DOMException(
        `Failed to execute 'arcTo' on '${this.constructor.name}': The radius provided (${
          radius
        }) is negative.`,
        'IndexSizeError',
      );
    ...
    if (arguments.length < 6) {
      throw new TypeError(
        `Failed to execute 'bezierCurveTo' on '${
          this.constructor.name
        }': 6 arguments required, but only ${arguments.length} present.`,
      );
    }
    const cpx1Result = Number(cpx1);
    const cpy1Result = Number(cpy1);
    ...
    if (arguments.length === 0) {
      ...
      if (path instanceof Path2D) {
        ...
        if (fillRule !== 'nonzero' && fillRule !== 'evenodd') {
          throw new TypeError(
            `Failed to execute 'clip' on '${this.constructor.name}': The provided value '${
              fillRule
            }' is not a valid enum value of type CanvasFillRule.`,
          );
        }
  ...
  createPattern(image, type) {
    ...
    if (type === 'repeat' || type === 'repeat-x' || type === 'repeat-y' || type === 'no-repeat') {
      ...
      throw new TypeError(
        `Failed to execute 'createPattern' on '${this.constructor.name}': The provided type ('${
          type
  ...
  drawFocusIfNeeded(path, element) {
    ...
    if (!(element instanceof Element)) {
      throw new TypeError(
        `Failed to execute 'drawFocusIfNeeded' on '${this.constructor.name}': parameter ${
          arguments.length
  ...
  ellipse(x, y, radiusX, radiusY, rotation, startAngle, endAngle, anticlockwise = false) {
    ...
    if (Number(radiusX) < 0) {
      throw new DOMException(
        `Failed to execute 'ellipse' on '${
          this.constructor.name
        }': The major-axis radius provided (${radiusX}) is negative.`,
        'IndexSizeError',
      );
    }
    if (Number(radiusY) < 0) {
      throw new DOMException(
        `Failed to execute 'ellipse' on '${
          this.constructor.name
        }': The minor-axis radius provided (${radiusY}) is negative.`,
        'IndexSizeError',
      );
    }
  ...
  getImageData(x, y, w, h) {
    ...
    if (w === 0 || h === 0) {
      throw new DOMException(
        `Failed to execute 'getImageData' on '${this.constructor.name}': The source ${
          w === 0 ? 'width' : 'height'
        } is 0.`,
        'IndexSizeError',
      );
  ...
  set globalCompositeOperation(value) {
    if (compositeOperations.includes(value)) {
      ...
      const event = createCanvasEvent('globalCompositeOperation', getTransformSlice(this), {
        value,
      });
      this._events.push(event);
    }
  ...
  isPointInPath(path, x, y, fillRule = 'nonzero') {
    ...
    if (fillRule !== 'nonzero' && fillRule !== 'evenodd') {
      throw new TypeError(
        `Failed to execute 'isPointInPath' on '${this.constructor.name}': The provided value '${
          fillRule
        }' is not a valid enum value of type CanvasFillRule.`,
      );
    }
  ...
  lineTo(x, y) {
    if (arguments.length < 2) {
      throw new TypeError(
        `Failed to execute 'lineTo' on '${this.constructor.name}': 2 arguments required, but only ${
          arguments.length
        } present.`,
      );
    }
  ...
  moveTo(x, y) {
    if (arguments.length < 2) {
      throw new TypeError(
        `Failed to execute 'moveTo' on '${this.constructor.name}': 2 arguments required, but only ${
          arguments.length
        } present.`,
      );
    }
  ...
  putImageData(data, x, y, dirtyX, dirtyY, dirtyWidth, dirtyHeight) {
    ...
    if (arguments.length > 3 && arguments.length < 7) {
      throw new TypeError(
        `Failed to execute 'putImageData' on '${
          this.constructor.name
        }': Valid arities are: [3, 7], but ${arguments.length} arguments provided.`,
      );
    }
    ...
    if (arguments.length === 3) {
      ...
      if (
        !Number.isFinite(
          xResult + yResult + dirtyXResult + dirtyYResult + dirtyWidthResult + dirtyHeightResult,
        )
      ) {
        return;
      }
  ...
  rect(x, y, width, height) {
    if (arguments.length < 4) {
      throw new TypeError(
        `Failed to execute 'rect' on '${this.constructor.name}': 4 arguments required, but only ${
          arguments.length
        } present.`,
      );
    }
  ...
  roundRect(x, y, width, height, radii) {
    ...
    if (radii.constructor === Array && (radii.length === 0 || radii.length > 4)) {
      throw new TypeError(
        `Failed to execute 'roundRect' on '${this.constructor.name}': ${
          radii.length
  ...
  scale(x, y) {
    if (arguments.length < 2) {
      throw new TypeError(
        `Failed to execute 'scale' on '${this.constructor.name}': 2 arguments required, but only ${
          arguments.length
        } present.`,
      );
    }
  ...
  setTransform(a, b, c, d, e, f) {
    if (arguments.length === 0) {
      ...
      if (a instanceof DOMMatrix) {
        ...
        throw new TypeError(
          `Failed to execute 'setTransform' on '${this.constructor.name}': parameter ${
            a
      ...
      throw new TypeError(
        `Failed to execute 'setTransform' on '${
          this.constructor.name
        }': Valid arities are: [0, 1, 6], but ${arguments.length} arguments provided.`,
      );
    }
    a = Number(a);
    b = Number(b);
